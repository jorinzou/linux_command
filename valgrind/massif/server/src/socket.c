...
void delete_sockfd_record(int sockfd)
{
	...
	if (src_record) {
		...
		close(src_record->sockfd);//测试不关闭，客户端在阻塞情况下close，会不会返回
		free(src_record);
	}
}
...
void mqtt_do_publish_msg(const uint8 *buf,int sockfd)
{
	...
	cJSON_AddStringToObject(root ,"DeviceAddr1", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr2", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr3", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr4", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr5", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr6", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr7", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr8", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr9", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr11", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr12", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr13", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr14", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr15", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr16", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr17", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr18", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr19", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr20", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr21", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr22", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr23", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr24", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr25", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr26", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr27", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr28", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr29", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr30", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr31", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr32", "00124b0014b5568f");
    cJSON_AddStringToObject(root ,"DeviceAddr33", "00124b0014b5568f");
    cJSON_AddNumberToObject(root ,"Epoint",6);
	cJSON_AddNumberToObject(root ,"Cluster_ID",512);
	cJSON_AddNumberToObject(root ,"Command",108);
    cJSON_AddNumberToObject(root ,"SendMode",2);
	cJSON_AddNumberToObject(root ,"AttriButeId1",1);
    cJSON_AddNumberToObject(root ,"AttriButeId2",2);
    cJSON_AddNumberToObject(root ,"AttriButeId3",3);
    cJSON_AddNumberToObject(root ,"AttriButeId4",4);
    cJSON_AddNumberToObject(root ,"AttriButeId5",5);
    cJSON_AddNumberToObject(root ,"AttriButeId6",6);
    cJSON_AddNumberToObject(root ,"AttriButeId7",7);
    cJSON_AddNumberToObject(root ,"AttriButeId8",8);
	char *JsonOut = cJSON_Print(root);
    DEBUG_INFO("json size = %d",strlen(JsonOut));
    cJSON_Delete(root);
    mqtt_publish(sockfd,"/get/dev_info_respon",JsonOut,strlen(JsonOut),0);
    free(JsonOut);
